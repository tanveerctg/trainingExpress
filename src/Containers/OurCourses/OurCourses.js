            ...
            <div>
              <div className={classes.itemContainer}>
                ...
                <div className={classes.secondPart} >
                  <div className={classes.courseName}>Level 2 Food Hygiene and Safety for Catering</div>
            ...
            <div>
              <div className={classes.itemContainer}>
                  <div className={classes.imgContainer}>
                    ...
                    <span className={classes.courseCategory}>Health and Safety</span>
                    <img
                  ...
                  <div className={classes.secondPart} >
                    <div className={classes.courseName}>Asbestos Awareness Training</div>
